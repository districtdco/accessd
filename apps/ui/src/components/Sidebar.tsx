    ...
    <>
      ...
      >
        <div className="flex h-16 items-center gap-2 border-b border-gray-200 px-6">
          ...
          <span className="text-lg font-semibold text-gray-900">PAM</span>
          <span className="ml-1 rounded bg-indigo-100 px-1.5 py-0.5 text-[10px] font-semibold text-indigo-700 uppercase">
            v1
          </span>
        </div>
        ...
        <div className="border-t border-gray-200 px-4 py-3">
          <p className="truncate text-xs text-gray-400">Privileged Access Management</p>
        </div>
      </aside>
    </>
  )
