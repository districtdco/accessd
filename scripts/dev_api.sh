...
export ACCESSD_ENV="${ACCESSD_ENV:-${PAM_ENV:-development}}"
export ACCESSD_DB_URL="${ACCESSD_DB_URL:-${PAM_DB_URL:-postgres://pam:pam_dev_password@127.0.0.1:5432/pam?sslmode=disable}}"
export ACCESSD_VAULT_KEY="${ACCESSD_VAULT_KEY:-${PAM_VAULT_KEY:-MDEyMzQ1Njc4OWFiY2RlZjAxMjM0NTY3ODlhYmNkZWY=}}"
export ACCESSD_LAUNCH_TOKEN_SECRET="${ACCESSD_LAUNCH_TOKEN_SECRET:-${PAM_LAUNCH_TOKEN_SECRET:-accessd-dev-launch-secret}}"
export ACCESSD_CONNECTOR_SECRET="${ACCESSD_CONNECTOR_SECRET:-${PAM_CONNECTOR_SECRET:-accessd-dev-connector-secret}}"
export ACCESSD_LAUNCH_MATERIALIZE_TIMEOUT="${ACCESSD_LAUNCH_MATERIALIZE_TIMEOUT:-${PAM_LAUNCH_MATERIALIZE_TIMEOUT:-5m}}"
export ACCESSD_HTTP_ADDR="${ACCESSD_HTTP_ADDR:-${PAM_HTTP_ADDR:-:8080}}"
export ACCESSD_SSH_PROXY_ADDR="${ACCESSD_SSH_PROXY_ADDR:-${PAM_SSH_PROXY_ADDR:-:2222}}"
export ACCESSD_SSH_PROXY_PUBLIC_HOST="${ACCESSD_SSH_PROXY_PUBLIC_HOST:-${PAM_SSH_PROXY_PUBLIC_HOST:-127.0.0.1}}"
export ACCESSD_SSH_PROXY_PUBLIC_PORT="${ACCESSD_SSH_PROXY_PUBLIC_PORT:-${PAM_SSH_PROXY_PUBLIC_PORT:-2222}}"
export ACCESSD_PG_PROXY_IDLE_TIMEOUT="${ACCESSD_PG_PROXY_IDLE_TIMEOUT:-${PAM_PG_PROXY_IDLE_TIMEOUT:-30m}}"
export ACCESSD_MYSQL_PROXY_IDLE_TIMEOUT="${ACCESSD_MYSQL_PROXY_IDLE_TIMEOUT:-${PAM_MYSQL_PROXY_IDLE_TIMEOUT:-30m}}"
export ACCESSD_MSSQL_PROXY_IDLE_TIMEOUT="${ACCESSD_MSSQL_PROXY_IDLE_TIMEOUT:-${PAM_MSSQL_PROXY_IDLE_TIMEOUT:-30m}}"
