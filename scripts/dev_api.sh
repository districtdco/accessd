...
export ACCESSD_MONGO_PROXY_IDLE_TIMEOUT="${ACCESSD_MONGO_PROXY_IDLE_TIMEOUT:-30m}"
...
echo "[dev_api] db_proxy_idle_timeout pg=$ACCESSD_PG_PROXY_IDLE_TIMEOUT mysql=$ACCESSD_MYSQL_PROXY_IDLE_TIMEOUT mssql=$ACCESSD_MSSQL_PROXY_IDLE_TIMEOUT mongo=$ACCESSD_MONGO_PROXY_IDLE_TIMEOUT"
