...
echo "   - pam-local-linux -> Shell"
echo "   - pam-local-linux -> SFTP"
echo "   - pam-local-postgres -> DBeaver"
echo "   - pam-local-mysql -> DBeaver"
echo "   - pam-local-mssql -> DBeaver"
echo "   - pam-local-redis -> Redis CLI"
...
echo "  - Redis client-leg TLS to PAM proxy is not implemented in this slice."
